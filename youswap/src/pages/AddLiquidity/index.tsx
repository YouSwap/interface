...
import { LightCard, CustomeCard } from '../../components/Card'
...
import SwapHeader from '../../components/AddLiquidity/SwapHeader'
...
export default function AddLiquidity({
  ...
  const modalHeader = () => {
    return noLiquidity ? (
      ...
      <AutoColumn gap="4px">
        ...
        <TYPE.black fontSize={12} textAlign="left" padding={'8px 0 0 0 '}>
  ...
  //   :hover,
  //   :focus {
  //     color: ${({ theme }) => darken(0.1, theme.primary6)};
  //   }
          ...
          <TransactionConfirmationModal
            ...
            content={() => (
              <ConfirmationModalContent
                title={noLiquidity ? t('creatingPool') : t('You will receive')}
                onDismiss={handleDismissConfirmation}
          ...
          <AutoColumn gap="20px">
            {noLiquidity ? (
              ...
              <ColumnCenter>
                <CustomeCard>
                  <AutoColumn gap="10px">
                    <TYPE.link fontSize={12} fontWeight={600} color={theme.text9} style={{ opacity: 0.5 }}>
                      {t('createLiqualityTips1')}
                    </TYPE.link>
                    <TYPE.link fontSize={12} fontWeight={400} color={theme.text9} style={{ opacity: 0.5 }}>
                      {t('createLiqualityTips2')}
                    </TYPE.link>
                    <TYPE.link fontSize={12} fontWeight={400} color={theme.text9} style={{ opacity: 0.5 }}>
                      {t('createLiqualityTips3')}
                    </TYPE.link>
                  </AutoColumn>
                </CustomeCard>
              </ColumnCenter>
            ...
            {addIsUnsupported ? (
              ...
              <AutoColumn gap={'md'}>
                ...
                {/* <CustomeCard>
                  <Text fontSize={12} fontWeight={400} color={'#06263C'} style={{opacity: 0.5}}>通过增加流动性，您将获得获得YOU奖励，如您所提供的流动性交易对未支持流动性质押获取YOU，您暂时将无法获得YOU奖励。</Text>
