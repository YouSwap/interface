    ...
    <>
      ...
      <AppBody>
        ...
        <Wrapper id="swap-page">
              ...
              <>
                ...
                <AutoRow justify="space-between" style={{ padding: '0 1rem' }}>
                  <ArrowWrapper clickable={false}>
                    <Repeat size="16" color={theme.text2} />
                  </ArrowWrapper>
          ...
          <BottomGrouping>
            {swapIsUnsupported ? (
              ...
              <GreyCard style={{ textAlign: 'center' }}>
                <TYPE.main mb="4px">{t('noLiquidity')}</TYPE.main>
                {singleHopOnly && <TYPE.main mb="4px">{t('tryMutiRoute')}</TYPE.main>}
              </GreyCard>
            ) : showApproveFlow ? (
              <RowBetween>
                <ButtonConfirmed
          ...
          {!swapIsUnsupported && trade && !showRoute && (
            <AutoColumn style={{ padding: '0 16px' }}>
              <InfoLink
                href={`${process.env.REACT_APP_CHART_DETAIL_URL}` + trade?.route.pairs[0].liquidityToken.address}
                target="_blank"
              >
