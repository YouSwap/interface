...
import { NoborderCard } from '../../components/Card'
...
import Row, { RowBetween, RowFixed, RowFlex } from '../../components/Row'
  ...
  function modalHeader() {
    return (
      <AutoColumn gap={'md'} style={{ marginTop: '20px' }}>
        ...
        <TYPE.black fontSize={12} color={theme.text2} textAlign="left" padding={'12px 0 0 0'}>
          {`${t('estimateError1')} ${allowedSlippage / 100}% ${t('estimateError2')}`}
        </TYPE.black>
      </AutoColumn>
    )
  }
        ...
        <Wrapper>
          ...
          <AutoColumn gap="md">
            <NoborderCard>
              <AutoColumn gap="20px">
                <RowBetween>
                  <Text fontSize={14} fontWeight={500}>{t('Amount')}</Text>
                  <ClickableText
                    fontWeight={500}
                    onClick={() => {
            ...
            {pair && (
              <div style={{ padding: '10px 20px', backgroundColor: '#EDEEF2', borderRadius: '10px' }}>
                <RowBetween>
                  {t('Price')}:
                  <div>
                    1 {currencyA?.symbol} = {tokenA ? pair.priceOf(tokenA).toSignificant(6) : '-'} {currencyB?.symbol}
            ...
            <div style={{ position: 'relative' }}>
              {!account ? (
                ...
                <RowBetween>
                  ...
                  >
                    <Text fontSize={16} fontWeight={500} style={{whiteSpace: 'nowrap'}}>
                      {error || t('Remove')}
                    </Text>
                  </ButtonError>
                </RowBetween>
