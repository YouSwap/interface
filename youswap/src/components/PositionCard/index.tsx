  ...
  return (
    <>
      {userPoolBalance && JSBI.greaterThan(userPoolBalance.raw, JSBI.BigInt(0)) ? (
        ...
        <LightCard>
          <TYPE.subHeader style={{ textAlign: 'start' }}>
            {t('liquidityDesc')}
          </TYPE.subHeader>
        </LightCard>
      )}
...
export default function FullPositionCard({ pair, border, stakedBalance }: PositionCardProps) {
  ...
  return (
    <StyledPositionCard border={border} bgColor="#F0F4FA">
      <CardNoise />
      <AutoColumn gap="12px">
        <FixedHeightRow>
          <AutoRow gap="8px">
          ...
          <RowFixed gap="8px">
            ...
            >
              {showMore ? (
                <>
                  {t('Manage')}
                  <ChevronUp size="40" style={{ marginLeft: '10px' }} />
                </>
              ) : (
                <>
                  {t('Manage')}
                  <ChevronDown size="40" style={{ marginLeft: '10px' }} />
                </>
              )}
            </ButtonEmpty>
          </RowFixed>
