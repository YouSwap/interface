...
export const ButtonPrimary = styled(Base)`
  background: linear-gradient(80deg, ${({ theme }) => theme.btnBg1}, ${({ theme }) => theme.btnBg2});
  color: white;
  border-radius: 8px;
  border: none;
  &:focus {
    background: linear-gradient(90deg, ${({ theme }) => theme.btnBg1}, ${({ theme }) => theme.btnBg2});
  }
  &:hover {
    opacity: 0.8;
    background: linear-gradient(90deg, ${({ theme }) => theme.btnBg1}, ${({ theme }) => theme.btnBg2});
...
export const ButtonLight = styled(Base)`
  background-color: rgb(53, 189, 177);
