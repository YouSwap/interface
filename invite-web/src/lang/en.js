export default {
    ...
    intro: [
        ...
        '1. Invite friends to stake LP Token, and you can get inviting mining benefits;',
        '2. The invitee can get extra mining benefits by staking mining;',
    ...
    inviteDig: [
        ...
        ' view',
        'Miners can click to receive the income to obtain the invitation computing power reward simultaneously.'
    ],
    tabs: [
        'Live',
        'Finished'
