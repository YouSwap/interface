...
<template>
  <div class="you-wrapper">
    <div class="card-title">
      ...
      <span class="more"
            @click="handleMoreClick">{{$t('More')}}</span>
    </div>
    <div class="list-title">
      <div class="title-item title-item1"
           style="justify-content: flex-start">{{$t('Stacked')}}</div>
      <div class="title-item title-item2"
           style="justify-content: flex-start; width: 80px;">{{$t('Earned')}}</div>
      <div class="title-item title-item3"
           style="justify-content: flex-end; padding-left: 52px">{{$t('APY')}}</div>
      <div v-if="IsPC()"
           class="title-item title-item3"
           style="justify-content: flex-end">{{$t('Action')}}</div>
    </div>
    <div class="line"></div>
    <div class="list">
      <div class="list-item"
        ...
        <div v-if="IsPC()"
             class="list-item-child list-item-child4">
          <el-button @click="handleLinkLiquatityDig"
                     size="mini">{{$t('LiquidityDig')}}</el-button>
        </div>
      </div>
    </div>
  </div>
